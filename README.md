...
```text
python scripts/mr-impact.py --help
python scripts/mr-impact.py analyze-issue --repo /work/risk --source /work/issue-input --output /work/issue-analysis
python scripts/mr-impact.py index-repository --repo /work/risk --deep
python scripts/mr-impact.py analyze-mr --repo /work/risk --base main --head HEAD --issue /work/issue-analysis/01-generated-issue.md --output /work/mr-analysis
python scripts/mr-impact.py update-issue --issue /work/issue-analysis/01-generated-issue.md --analysis /work/mr-analysis --output /work/mr-analysis --target risk#1427
```
...
The four compact wrappers are in `.github/skills/<name>/SKILL.md`. Their structure
...
- [Complete workflow and CLI reference](docs/workflow.md)
- [Issue interpretation and dynamic templates](docs/issue-workflow.md)
- [MR analysis and QA interpretation](docs/mr-workflow.md)
- [Index storage, freshness, and organization catalogs](docs/index-storage.md)
- [Adapter extension guide](docs/adapters.md)
- [Trust boundaries and resource limits](docs/security.md)
- [Testing and reproducible demonstration](docs/testing.md)
- [Known limitations](docs/limitations.md)
- [Implementation and validation report](docs/implementation-report.md)
- [Generated example reports](examples/output/README.md)

Run `python -m unittest discover -v` for automated validation. Run
`python scripts/run-example.py --output examples/output` to recreate the
