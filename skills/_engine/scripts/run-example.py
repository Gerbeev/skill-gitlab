...
def run(output: Path):
    ...
    with tempfile.TemporaryDirectory(prefix="mr-impact-example-") as temporary:
        ...
        write_text(output / "README.md", "# Generated local workflow example\n\n"
                   "Generated with `python skills/_engine/scripts/run-example.py --output docs/examples/output`.\n\n"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=Path, default=REPOSITORY / "docs/examples/output")
